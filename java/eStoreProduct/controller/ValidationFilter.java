...
public class ValidationFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        // Create a DataSource object and set the database connection details
        ...
        // Create an instance of customerDAOImp and pass the DataSource to its constructor
        customerDAO custDAO = new customerDAOImp(dataSource);
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        String email = httpRequest.getParameter("em");
        String psd = httpRequest.getParameter("ps");

        // Perform the validation using the ValidationUtility
        custCredModel customer = validationUtility.validateCustomer(email, psd);
